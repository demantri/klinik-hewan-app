                    ...
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('forgot-password')?>" method="post" id="myForm">
                                    <div class="form-group">
                                        <label for="username">Username</label>
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" placeholder="Masukan username" id="username" name="username" autofocus>
                                            <button class="btn btn-light" type="button" id="btn-cari" style="border-radius: 0px 4px 4px 0px;">
                                                <i class="fas fa-search"></i>
                                            </button>
                                        </div>
                                    </div>

                                    <div class="d-none" id="div_content">
                                        <div class="form-group">
                                        ...
                                        <!-- <div class="form-group">
                                            <label for="password-confirm">Konfirmasi Passowrd</label>
