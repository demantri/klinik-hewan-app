            ...
            <div class="container mt-5">
                ...
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    ...
                    <div class="card card-primary">
                        <div class="card-header"><h4>Form Booking</h4></div>
                                ...
                                <form action="<?= base_url('booking') ?>" method="post">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input id="tgl_booking" type="date" class="form-control" name="tgl_booking" value="<?= set_value('tgl_booking') ?>" autofocus required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="nama_lengkap" id="nama_lengkap" class="form-control" required>
                                            <option value="" selected disabled>- Pilih -</option>
                                            <?php foreach ($pemilik as $data) { ?>
                                            <option value="<?= $data->id_pemilik ?>"><?= $data->nama_lengkap ?></option>
                                            <?php } ?>
                                        </select>
                                        <?php if(isset($validation)):?>
