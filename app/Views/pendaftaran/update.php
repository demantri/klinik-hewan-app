                    ...
                    <div class="form-group">
                        ...
                        <select name="pemilik" id="pemilik" class="form-control <?= $validation->hasError('pemilik') ? 'is-invalid' : ''?>" required>
                            ...
                            <option value="<?= $item->id_pemilik ?>" 
                                <?= set_select('pemilik', $item->id_pemilik)?>
                                <?= $item->id_pemilik == $pendaftaran->id_pemilik ? 'selected' : ''?>    
                            ><?= $item->id_pemilik . '/' . $item->nama_lengkap ?></option>
                            <?php endforeach; ?>
                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="spesies" id="spesies" class="form-control <?= $validation->hasError('spesies') ? 'is-invalid' : ''?>" required>
                                    ...
                                    <option value="<?= $item->deskripsi ?>"
                                        <?= set_select('spesies', $item->deskripsi)?>
                                        <?= $item->deskripsi == $pendaftaran->spesies ? 'selected' : ''?>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="ras" id="ras" class="form-control <?= $validation->hasError('ras') ? 'is-invalid' : ''?>" required>
                                    ...
                                    <option value="<?= $item->deskripsi ?>" 
                                        <?= set_select('ras', $item->deskripsi)?>
                                        <?= $item->deskripsi == $pendaftaran->ras ? 'selected' : ''?>
                                    ><?= $item->deskripsi ?></option>
                                    <?php endforeach; ?>
                                </select>
